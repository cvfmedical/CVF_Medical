...
import { OrcamentosAguardandoAprovacao } from './pages/pipeline/OrcamentosAguardandoAprovacao';
...
import { HistoricoEquipamento } from './pages/pipeline/HistoricoEquipamento';
...
const TELAS_IMPLEMENTADAS: Record<string, React.ComponentType> = {
  ...
  '/orcamentos-aguardando-aprovacao': OrcamentosAguardandoAprovacao,
  ...
  '/entrega': Entrega,
  '/historico-equipamento': HistoricoEquipamento,
  '/laudos': Laudos,
