...
export const MENU: CategoriaMenu[] = [
  ...
  },
  {
    ...
    itens: [
      ...
      { label: 'Cadastro de itens (peças)', path: '/produtos-servicos', categoria: 'catalogo_precos', implementado: false },
      { label: 'Produtos e serviços (equipamentos)', path: '/produtos-e-servicos', categoria: 'catalogo_precos', implementado: false },
      ...
      { label: 'Avarias de triagem', path: '/avarias-triagem', categoria: 'cadastros_gerais', implementado: false },
      { label: 'Grupos de produtos/serviços', path: '/categorias-produtos-servicos', categoria: 'cadastros_gerais', implementado: false },
