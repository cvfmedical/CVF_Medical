...
export function AvariasTriagem() {
  ...
  return (
    <CrudPage<AvariaTriagem>
      titulo="Avarias de triagem"
      tabela="avarias_triagem"
      ...
      campos={[
        ...
        {
          name: 'grupo',
          label: 'Grupo (opcional - deixe em branco pra aparecer pra qualquer equipamento)',
          type: 'combobox',
